...
angular.module('PooperSnooper', ['ionic', 'backand', 'PooperSnooper.controllers', 'PooperSnooper.services', 'ngCordova'])
  ...
  .config(function($stateProvider, $urlRouterProvider, BackandProvider, $httpProvider) {
    ...
    BackandProvider.setAppName('poopersnooper123');
    BackandProvider.setSignUpToken('97147591-49a1-4572-b541-ecbdeac00cf3');
    BackandProvider.setAnonymousToken('ae651258-5200-4c75-a704-8acba9f92740');
